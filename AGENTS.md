...
At the end of each phase, we generate a **single copy-paste Codex prompt** for the next
...
in. This keeps Codex focused and stops it rewriting finished work.

**Next step:** on your go, we generate the **Phase 0** Codex prompt.
